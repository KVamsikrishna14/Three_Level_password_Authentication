...
namespace TLPAS
{
    ...
    {
        SqlConnection con; //= new SqlConnection(@"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename = C:\Users\vk539\Desktop\java; Integrated Security = True; Connect Timeout = 30");
